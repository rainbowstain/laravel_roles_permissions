                  ...
                  <form action="{{ route('articles.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="my-3 w-full lg:w-1/2">
                             <input value="{{ old('title') }}" name="title" placeholder="Nuevo Titulo" type="text"
                    ...
                    <div class="my-3 w-full lg:w-1/2">
                        <textarea name="text" id="text" class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" cols="30" rows="10" >
                            {{ old('text') }}
                        </textarea>
                        ...
                        <div class="my-3 w-full lg:w-1/2">
                             ...
                             <input value="{{ old('author') }}" name="author" placeholder="Ingrese el autor" type="text"
                         class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" >
